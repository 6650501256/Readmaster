...
app.hideDialogs();
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="dialogtask1" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-image-push v-bind="imgpush2"></dab-image-push><dab-image v-bind="image1"></dab-image><dab-image v-bind="image2"></dab-image></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe3: {
            name: "iframe3",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://reading-for-main-idea-11.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
...
app.hideDialogs();
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot11" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe3"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://fir-564a4.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
 ...
 created() {
      ...
      data() {
        return {
          ...
          image6: {
            name: "image6",
            url: "app/images/474774869_596035186564660_3536454186614773942_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="dialog1" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-image v-bind="image6"></dab-image></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://decsoft-database.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot21"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot21").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot21").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot21" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://krystal-naam.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot22"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot22").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot22").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot22" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://scanning-e106e.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot23"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot23").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot23").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot23" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot24"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot24").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot24").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot24" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://fact-6daf3.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot31"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot31").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot31").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot31" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://fact-2580c.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot32"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot32").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot32").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot32" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://fact-8eb7d.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot33"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot33").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot33").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://fact-7f583.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot34"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot34").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot34").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://supporting-f78fe.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot41"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot41").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot41").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot41" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://supporting-4857d.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot42"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot42").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot42").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot42" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://supporting-b3173.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot43"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot43").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot43").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://supporting-33d64.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot44"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot44").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot44").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot44" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://skimming-fc65f.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot51"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot51").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot51").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot51" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot52"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot52").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot52").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot52" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot53"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot53").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot53").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot53" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
      ...
      data() {
        return {
          ...
          iframe1: {
            name: "iframe1",
            title: " Created with Unregistered DecSoft App Builder",
            source: "https://skimming-fd50e.web.app/",
            classes: "",
            hidden: false,
            event: null,
            loadHandler() {}
          ...
          imgpush2: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = dialogs["Ansbot54"].imgpush2;
                self.event = event;
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#Ansbot54").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#Ansbot54").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="Ansbot54" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#dialog2").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="dialog2" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.hideDialogs();
      ...
      mounted() {
        let
          self = this;
        $("#dialog3").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#dialog3").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="dialog3" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe><dab-image-push v-bind="imgpush2"></dab-image-push></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
const dialog4 = {
 components: DabComponents,
 created() {
      ...
      mounted() {
        let
          self = this;
        $("#dialog4").on("show.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
        ...
        $("#dialog4").on("hidden.bs.modal", function () {
          let
            view = self,
            views = app._getLoadedViews(),
            frames = app._getLoadedFrames(),
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<div id="dialog4" class="app-dialog modal fade" tabindex="-1" role="dialog"><div v-bind:class="['modal-dialog', 'modal-dialog-scrollable', 'modal-dialog-centered', 'modal-' + size, 'modal-' + fullscreen]" role="document"><div class="modal-content"><div v-bind:class="[classes, 'modal-body']"><dab-iframe v-bind="iframe1"></dab-iframe></div></div></div></div>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
</dab-html><dab-image v-bind="image4"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image1"></dab-image><dab-image v-bind="image2"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
document.getElementById("submit1").addEventListener("click", function() {
    let name = document.getElementById("input4").value;
    let answer1 = document.getElementById("input1").value;
    let answer2 = document.getElementById("input3").value;
    ...
    fetch("https://learning-task-75d58-default-rtdb.asia-southeast1.firebasedatabase.app/responses.json", {
        method: "POST",
        headers: {
    ...
    .then(data => {
        alert("บันทึกข้อมูลเรียบร้อย! กำลังไปยังหน้าถัดไป...");

        // ล้างข้อมูลในช่องป้อนหลังจากบันทึกสำเร็จ
        document.getElementById("input4").value = "";
        document.getElementById("input1").value = "";
        document.getElementById("input3").value = "";

        app.showView('mission1');
    })
    .catch(error => {
...
app.showDialog('dialogtask1');
          ...
          image9: {
            name: "image9",
            url: "app/images/476017503_653788030546030_7191723399619370568_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="task1" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="submit1"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image2"></dab-image><dab-text-input v-model="input1.value" v-bind="input1"></dab-text-input><dab-text-input v-model="input3.value" v-bind="input3"></dab-text-input><dab-text-input v-model="input4.value" v-bind="input4"></dab-text-input><dab-image v-bind="image9"></dab-image><dab-image v-bind="image10"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
document.getElementById("submit2").addEventListener("click", function() {
    let name = document.getElementById("input4").value;  // ช่องกรอกชื่อ
    let challenge = document.getElementById("input21").value; // คำตอบเกี่ยวกับปัญหาของ Emily
    let solution = document.getElementById("input22").value; // คำตอบเกี่ยวกับการแก้ปัญหา

    // ตรวจสอบว่าผู้ใช้กรอกข้อมูลครบทุกช่อง
    if (name === "" || challenge === "" || solution === "") {
        alert("กรุณากรอกข้อมูลให้ครบทุกช่อง");
        return;
    }
    ...
    // ใช้ Fetch API เพื่อส่งข้อมูลไป Firebase
    fetch("https://learning-task-75d58-default-rtdb.asia-southeast1.firebasedatabase.app/responses.json", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
    ...
    .then(data => {
        ...
        // เปลี่ยนหน้าไป mission2.html
        app.showView('mission2');
    })
    .catch(error => {
        alert("เกิดข้อผิดพลาดในการบันทึกข้อมูล");
        console.error("Error:", error);
...
app.showSidebar();
          ...
          image4: {
            name: "image4",
            url: "app/images/476008203_983688440602070_6185888541320784991_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
          ...
          image5: {
            name: "image5",
            url: "app/images/472889650_603350625727682_578596253653222589_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
...
app.showDialog('dialogtask2');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="task2" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="submit2"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image4"></dab-image><dab-text-input v-model="input21.value" v-bind="input21"></dab-text-input><dab-image v-bind="image5"></dab-image><dab-text-input v-model="input22.value" v-bind="input22"></dab-text-input><dab-image v-bind="image2"></dab-image><dab-text-input v-model="input4.value" v-bind="input4"></dab-text-input></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
document.getElementById("submit3").addEventListener("click", function() {
    let name = document.getElementById("input4").value;  // ช่องกรอกชื่อ
    let concern = document.getElementById("input31").value; // คำตอบเกี่ยวกับความกังวลของ Mark
    let teacherHelp = document.getElementById("input2").value; // คำตอบเกี่ยวกับการช่วยเหลือของครู

    // ตรวจสอบว่าผู้ใช้กรอกข้อมูลครบทุกช่อง
    if (name === "" || concern === "" || teacherHelp === "") {
        alert("กรุณากรอกข้อมูลให้ครบทุกช่อง");
        return;
    }
    ...
    .then(data => {
        ...
        // เปลี่ยนหน้าไป mission3.html
        app.showView('mission3');
    })
    .catch(error => {
        alert("เกิดข้อผิดพลาดในการบันทึกข้อมูล");
        console.error("Error:", error);
...
app.showSidebar();
          ...
          image4: {
            name: "image4",
            url: "app/images/474864414_491112430386597_2640080526061081579_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
          ...
          image5: {
            name: "image5",
            url: "app/images/474887776_653405150446011_1521954074257990456_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
...
app.showDialog('dialogtask3');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="task3" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="submit3"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image5"></dab-image><dab-text-input v-model="input31.value" v-bind="input31"></dab-text-input><dab-text-input v-model="input2.value" v-bind="input2"></dab-text-input><dab-image v-bind="image2"></dab-image><dab-text-input v-model="input4.value" v-bind="input4"></dab-text-input></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
document.getElementById("submit4").addEventListener("click", function() {
    let name = document.getElementById("input4").value;  // ช่องกรอกชื่อ
    let difficulty = document.getElementById("input41").value; // คำตอบเกี่ยวกับความยากของ Sally
    let suggestion = document.getElementById("input42").value; // คำตอบเกี่ยวกับคำแนะนำของเพื่อน

    // ตรวจสอบว่าผู้ใช้กรอกข้อมูลครบทุกช่อง
    if (name === "" || difficulty === "" || suggestion === "") {
        alert("กรุณากรอกข้อมูลให้ครบทุกช่อง");
        return;
    }
    ...
    .then(data => {
        ...
        // เปลี่ยนหน้าไป mission4.html
        app.showView('mission4');
    })
    .catch(error => {
        alert("เกิดข้อผิดพลาดในการบันทึกข้อมูล");
        console.error("Error:", error);
...
app.showSidebar();
          ...
          image5: {
            name: "image5",
            url: "app/images/475983688_982085343248416_3440545791117027138_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
          ...
          image6: {
            name: "image6",
            url: "app/images/474715690_501625209230020_477066588806828149_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
...
app.showDialog('dialogtask4');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="task4" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="submit4"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image6"></dab-image><dab-text-input v-model="input41.value" v-bind="input41"></dab-text-input><dab-text-input v-model="input42.value" v-bind="input42"></dab-text-input><dab-image v-bind="image2"></dab-image><dab-text-input v-model="input4.value" v-bind="input4"></dab-text-input></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
document.getElementById("submit5").addEventListener("click", function() {
    let name = document.getElementById("input4").value;  // ช่องกรอกชื่อ
    let excitement = document.getElementById("input51").value; // คำตอบเกี่ยวกับความตื่นเต้นของ Lily
    let advice = document.getElementById("input52").value; // คำตอบเกี่ยวกับคำแนะนำจากพ่อของ Lily

    // ตรวจสอบว่าผู้ใช้กรอกข้อมูลครบทุกช่อง
    if (name === "" || excitement === "" || advice === "") {
        alert("กรุณากรอกข้อมูลให้ครบทุกช่อง");
        return;
    }
    ...
    .then(data => {
        ...
        // เปลี่ยนหน้าไป mission5.html
        app.showView('mission5');
    })
    .catch(error => {
        alert("เกิดข้อผิดพลาดในการบันทึกข้อมูล");
        console.error("Error:", error);
...
app.showSidebar();
          ...
          image6: {
            name: "image6",
            url: "app/images/474433886_3927201170941817_832661241817501118_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
          ...
          image7: {
            name: "image7",
            url: "app/images/474885549_877074871047301_7923493750898938653_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
          ...
          image8: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = views["task5"].image8;
                self.event = event;

app.showDialog('dialogtask5');
            },
            dblclickHandler() {},
            mouseupHandler() {},
            mousedownHandler() {},
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="task5" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="submit5"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image7"></dab-image><dab-text-input v-model="input51.value" v-bind="input51"></dab-text-input><dab-text-input v-model="input52.value" v-bind="input52"></dab-text-input><dab-image v-bind="image8"></dab-image><dab-text-input v-model="input4.value" v-bind="input4"></dab-text-input></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showDialog('Ansbot21');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot21" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image6"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showDialog('Ansbot31');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot31" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image6"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot53');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot52" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image2"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
   ...
   this.$root.views[this.name] = this;
      ...
      data() {
        return {
          ...
          image8: {
            name: "image8",
            url: "app/images/475002179_1124685546027972_9006576970283868475_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "fill",
          ...
          image6: {
            name: "image6",
            url: "app/images/474942000_1150012416815849_4340360600018009714_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
          ...
          imgpush1: {
            name: "imgpush1",
            image: "app/images/474942000_1150012416815849_4340360600018009714_n.png",
            classes: "",
            title: " Created with Unregistered DecSoft App Builder",
            tabIndex: 0,
            kind: "light",
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="Login" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image8"></dab-image><dab-image v-bind="image2"></dab-image><dab-text-input v-model="input1.value" v-bind="input1"></dab-text-input><dab-text-input v-model="input2.value" v-bind="input2"></dab-text-input><dab-text-input v-model="input4.value" v-bind="input4"></dab-text-input><dab-image v-bind="image6"></dab-image><dab-image-push v-bind="imgpush1"></dab-image-push></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot11');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="mission1" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image8"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot21');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="mission2" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image3"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image1"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image8"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot31');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="mission3" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image7"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showView('taskbot41');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="mission4" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image7"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showSidebar();
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="mission5" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image6"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image5"></dab-image><dab-image v-bind="image8"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showSidebar();
          ...
          image6: {
            name: "image6",
            url: "app/images/474609101_1004635704854241_3183330216806937101_n.png",
            classes: "",
            description: "",
            title: " Created with Unregistered DecSoft App Builder",
            imageFit: "contain",
...
</dab-html><dab-image v-bind="image5"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image1"></dab-image><dab-image v-bind="image6"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
app.showDialog('dialog2');
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot53" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image5"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
          ...
          image5: {
            ...
            clickHandler(event) {
              let
                ...
                frames = app._getLoadedFrames(),
                dialogs = app._getLoadedDialogs(),
                self = views["taskbot54"].image5;
                self.event = event;

app.showDialog('dialog3');
            },
            dblclickHandler() {},
            mouseupHandler() {},
            mousedownHandler() {},
      ...
      template: `<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->
<transition v-bind:[app.viewTransitionName]="transitionName" v-bind:[app.viewTransitionMode]="transitionMode" v-bind:[app.viewInAnimation]="'animate__animated ' + 'animate__' + inAnimation" v-bind:[app.viewOutAnimation]="'animate__animated ' + 'animate__' +  outAnimation"><div title="Created with Unregistered DecSoft App Builder" id="taskbot54" v-bind:class="['app-view', classes]"><dab-sidebar v-bind="app.sidebar"></dab-sidebar><dab-image v-bind="image1"></dab-image><dab-image v-bind="image4"></dab-image><dab-image v-bind="image3"></dab-image><dab-image v-bind="image7"></dab-image><dab-image v-bind="image2"></dab-image><dab-image v-bind="image5"></dab-image></div></transition>
<!-- (Unregistered DecSoft App Builder - https://www.decsoftutils.com/) -->`
  };
...
const DabApp = {
  ...
  components: {
    "dab-alert": DabAlert,
    "dab-toast": DabToast,
    start,home,collaboration,coaching1,coaching2,problem1,problem2,problem3,problem4,problem5,learning1,learning2,learning3,learning4,learning5,compre1,compre2,compre3,compre4,compre5,scaf1,scaf2,scaf3,scaf4,scaf5,task1,task2,task3,task4,task5,taskbot11,taskbot12,taskbot21,taskbot22,taskbot23,taskbot24,taskQ1,taskQ2,taskQ3,taskQ4,taskQ5,taskbot31,taskbot32,taskbot33,taskbot34,taskbot41,taskbot42,taskbot43,taskbot44,taskbot51,taskbot52,Login,mission1,mission2,mission3,mission4,mission5,view1,taskbot53,taskbot54,
    dialogscafproce,dialogscafstretegic,dialogscafmeta,dialogconcep1,dialogconcep2,dialogconcep3,dialogconcep4,dialogconcep5,dialoghandout1,dialoghandout2,dialoghandout3,dialoghandout4,dialoghandout5,dialogtask1,dialogtask2,dialogtask3,dialogtask4,Ansbot11,Ansbot12,dialogtask5,dialog1,Ansbot21,Ansbot22,Ansbot23,Ansbot24,Ansbot31,Ansbot32,Ansbot33,Ansbot34,Ansbot41,Ansbot42,Ansbot43,Ansbot44,Ansbot51,Ansbot52,Ansbot53,Ansbot54,dialog2,dialog3,dialog4
  },
...
const router = VueRouter.createRouter({
  ...
  routes: [
    ...
    { path: '/Login', component: Login, name: 'Login', Login, props(route) { app.query = $.isEmptyObject(route.query) ? false : route.query; } },
    { path: '/mission1', component: mission1, name: 'mission1', mission1, props(route) { app.query = $.isEmptyObject(route.query) ? false : route.query; } },
    { path: '/mission2', component: mission2, name: 'mission2', mission2, props(route) { app.query = $.isEmptyObject(route.query) ? false : route.query; } },
    { path: '/mission3', component: mission3, name: 'mission3', mission3, props(route) { app.query = $.isEmptyObject(route.query) ? false : route.query; } },
    { path: '/mission4', component: mission4, name: 'mission4', mission4, props(route) { app.query = $.isEmptyObject(route.query) ? false : route.query; } },
    { path: '/mission5', component: mission5, name: 'mission5', mission5, props(route) { app.query = $.isEmptyObject(route.query) ? false : route.query; } },
    ...
    { path: '/taskbot54', component: taskbot54, name: 'taskbot54', taskbot54, props(route) { app.query = $.isEmptyObject(route.query) ? false : route.query; } }
  ]
});
